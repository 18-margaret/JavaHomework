...
public class FontMetrics extends JPanel {
    public void paintComponent (Graphics g){
      ...
      //Class FontMetrics collides with java.awt namespace, which contains it's own FontMetrics class
      //use fully qualified name space to avoid namespace collision
